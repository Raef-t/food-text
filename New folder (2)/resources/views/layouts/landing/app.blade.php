...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="{{\App\CentralLogics\Helpers::get_image_helper($icon,'value', asset('storage/app/business/').'/' . $icon?->value, asset('assets/landing/img/favicon.svg') ,'business/' )}}">
    @stack('css_or_js')
            ...
            <div class="container">
                <div class="navbar-bottom-wrapper">
                    ...
                    src="{{ \App\CentralLogics\Helpers::get_image_helper(
                        $fav,'value',
                        asset('storage/app/business/').'/'. $fav->value??'',
                ...
                <div class="footer-wrapper ps-xl-5">
                    <div class="footer-widget">
                        <div class="footer-logo">
                            <a class="logo">
                                <img  class="onerror-image"  data-onerror-image="{{ asset('assets/admin/img/160x160/img2.jpg') }}" src="{{ \App\CentralLogics\Helpers::get_image_helper($logo,'value', asset('storage/app/business/') .'/'. $logo->value??'', asset('assets/admin/img/upload-img.png') , 'business/') }}" alt="image">
                            </a>
                        </div>
                        <div class="txt">
