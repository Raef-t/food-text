...
class DeliverymanController extends Controller
{
    ...
    public function getList(Request $request)
    {
        ...
        $deliveryMen = DeliveryMan::with("last_location")->get();
    ...
    public function get_current_orders(Request $request)
    {
        ...
        $orders = Order::with(['customer', 'store', 'parcel_category',"group_order.OrderGroupId.store","group_order.mainOrder.store"])
    ...
    public function get_latest_orders(Request $request)
    {
        ...
        $orders = Order::with(['customer', 'store', 'parcel_category', "OrderRequests.deliveryMan", "group_order.OrderGroupId.store","group_order.mainOrder.store"]);
    ...
    public function get_order(Request $request)
    {
        ...
        $order = Order::with(['customer', 'store', 'details', 'parcel_category', 'payments', "group_order"])->where(['id' => $request['order_id']])->Notpos()->first();
        if (!$order) {
            return response()->json([
                'errors' => [
                    ['code' => 'order', 'message' => translate('messages.not_found')]
