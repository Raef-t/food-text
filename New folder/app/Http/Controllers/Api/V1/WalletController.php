...
$havePendingPayment=WalletPayment::where('user_id',$customer->id)->where('payment_status','pending')->first();
if(!$havePendingPayment){
    ...
    return response()->json(['errors' => ['message' => translate('messages.You have pending payment')]], 403);
}
