...
class ItemController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        $dataNotif = [
            ...
            'description' => "لسعر اقل هل لديك عرض افضل ؟".$p->name." قام بتغير سعر".$p->store_id."المتجر رقم",
            'module_id' => $store->module_id,
            'zone_id' => $store->zone_id,
            'type' => 'new_order',
        ];
        $topic='zone_'.$store->zone_id.'_store';
        Helpers::send_push_notif_to_topic($dataNotif,$topic,"new_order",);
