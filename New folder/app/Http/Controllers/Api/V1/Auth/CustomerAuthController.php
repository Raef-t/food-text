    ...
    public function register(Request $request)
    {
        ...
        if($customer_verification && env('APP_MODE') !='demo')
        {
            ...
            if($published_status == 1){
                $response = SmsGateway::sendSms($request['phone'],$otp);
            }else{
        ...
        return response()->json(['token' => $token, 'is_phone_verified' => 0, 'phone_verify_end_url' => "api/v1/auth/verify-phone","response"=>$response], 200);
    }
