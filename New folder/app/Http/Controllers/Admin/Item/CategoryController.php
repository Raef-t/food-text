...
class CategoryController extends BaseController
{
    ...
    public function getCategoryCollcetionView(Request $request): View
    {
        ...
        $language = getWebConfig('language');
        $defaultLang = str_replace('_', '-', app()->getLocale());
        return view("admin-views.category.collection_category", compact('collectionGroup','language','defaultLang','mainCategories'));
    }
    public  function  setCategoryCollection(Request $request)
    {
        $collectionGroup=new CollectionGroup();
        // Convert each category ID to an integer
...
// Assign the array to the idsCategory property
        $collectionGroup->idsCategory = json_encode($categories);
       $collectionGroup->name=$request->name;
       $collectionGroup->save();
       toastr()->success(translate('messages.collection_category_added_successfully'));
       return back();
    }
