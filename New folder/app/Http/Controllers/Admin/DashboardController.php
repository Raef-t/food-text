...
class DashboardController extends Controller
{
    ...
    public function dashboard(Request $request)
    {
        ...
        $orderProcessingTime = $order->pluck('processing')->toArray();
        return view("admin-views.dashboard-{$module_type}", compact('data', 'total_sell', 'commission', 'delivery_commission', 'label','params','module_type','orders','orderProcessingTime'));
