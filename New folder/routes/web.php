...
Route::group(['prefix' => 'payment-mobile'], function () {
    Route::get('/', 'MyFatoorahController@index')->name('payment-mobile');
    Route::get('/package/{packageId}', 'MyFatoorahController@indexPackagePay')->name('payment-mobile-package');
    Route::get('/success', 'MyFatoorahController@successPackagePay');
    Route::get('/fail', 'MyFatoorahController@failCallbackPackagePay');
    Route::get('set-payment-method/{name}', 'PaymentController@set_payment_method')->name('set-payment-method');
});

Route::get('payment-success', 'MyFatoorahController@successCallback')->name('payment-success');
Route::get('payment-fail', 'MyFatoorahController@failCallback')->name('payment-fail');
Route::get('payment-cancel', 'MyFatoorahController@failCallback')->name('payment-cancel');
...
if (!$is_published) {
    Route::group(['prefix' => 'payment'], function () {
        ...
        Route::group(['prefix' => 'myfatoorah', 'as' => 'myfatoorah.'], function () {
            Route::get('pay', [MyFatoorahController::class, 'indexWalletPay'])->name('pay');
            Route::get('success', [MyFatoorahController::class, 'successCallbackWallet'])
                ->withoutMiddleware([\App\Http\Middleware\VerifyCsrfToken::class]);
            Route::get('failed', [MyFatoorahController::class, 'failCallbackWallet'])
                ->withoutMiddleware([\App\Http\Middleware\VerifyCsrfToken::class]);
            Route::get('canceled', [MyFatoorahController::class, 'failCallbackWallet'])
                ->withoutMiddleware([\App\Http\Middleware\VerifyCsrfToken::class]);
        });
