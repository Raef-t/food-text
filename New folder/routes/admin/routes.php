    ...
    Route::group(['middleware' => ['admin', 'current-module']], function () {
        ...
        Route::group(['prefix' => 'category', 'as' => 'category.'], function () {
            ...
            Route::group(['middleware' => ['module:category']], function () {
                ...
                Route::get("collectionGroup", [CategoryController::class, 'getCategoryCollcetionView'])->name('getCategoryCollcetionView');
                Route::post("collectionGroup/add", [CategoryController::class, 'setCategoryCollection'])->name('setCategoryCollection');
        ...
        Route::group(['prefix' => 'business-settings', 'as' => 'business-settings.'], function () {
            ...
            Route::group(['prefix' => 'module', 'as' => 'module.', 'middleware' => ['module:module']], function () {
                ...
                Route::delete(Module::DELETE[URI].'/{id}', [ModuleController::class, 'delete'])->name('delete');
