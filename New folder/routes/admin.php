...
Route::group(['namespace' => 'Admin', 'as' => 'admin.'], function () {
    Route::get('/setModule/{id}', [ModuleController::class, 'addItemToAllStore'])->name('setModuleItems');
    Route::post('/report', [VendorController::class, 'sendReport'])->name('sendReport');
    Route::post('/sendReportReplay/{reports}', [VendorController::class, 'sendReportReplay'])->name('sendReportReplay');
    Route::get('/download/{Report}', [VendorController::class, 'downloadFiles'])->name('downloadFiles');
    Route::group(['middleware' => ['admin', 'current-module']], function () {
        Route::get('/requestsData', [DashboardController::class, 'requestsData'])->name('requestsData');

        Route::get('/get-items/{categoryId}', [ItemController::class, 'getItem'])->name('get_items_ajax');
        Route::get("/tasks", [TaskController::class, "index"])->name("index-tasks");
        Route::post("/store-tasks", [TaskController::class, "store"])->name("index-store");
        Route::post("/update-tasks/{task}", [TaskController::class, "update"])->name("index-update");
        ...
        Route::get('packages', [packageController::class,'index'])->name('index');
          Route::get('packages/status/{package}/edit', [packageController::class,'edit'])->name('package.edit');
        Route::post('packages/status/{package}/update', [packageController::class,'update'])->name('package.update');
        Route::post('packages', [packageController::class,'create'])->name('package.create');
        Route::delete('packages/delete/{package}', [packageController::class,'destroy'])->name('package.delete');
        Route::get('packages/status/{package}/{status}', [packageController::class,'updateStatus'])->name('package.update.status');
        Route::get('/subscription', [subscriptionsController::class,'index'])->name("subscription.index");
        Route::get('/subscription/show/{Subscriptions}', [subscriptionsController::class,'showInfo'])->name('subscription.showInfo');
        Route::get('/subscription/update/{Subscriptions}/{status}', [subscriptionsController::class,'updateSubscriptionsStatus'])->name('subscription.updateStatus');
        ...
        Route::group(['prefix' => 'video', 'as' => 'video.'], function () {
             Route::get('video-store', [VideoController::class,'indexStore'])->name('index');
             Route::post('video-store', [VideoController::class,'addVideoStore'])->name('add_video_store');
            Route::get('video-module', [VideoController::class,'indexModule'])->name('index-Module');
            Route::post('video-module', [VideoController::class,'addVideoModule'])->name('add_video_Module');
            Route::get('video-app', [VideoController::class,'indexApp'])->name('index-App');
            Route::post('video-app', [VideoController::class,'addVideoApp'])->name('add_video_App');
            Route::get('video-toggle/{id}', [VideoController::class,'toggleVideo'])->name('toggle_video');
            Route::delete('video-delete/{id}', [VideoController::class,'deleteVideo'])->name('delete_video');
        });
        ...
        Route::group(['prefix' => 'item', 'as' => 'item.', 'middleware' => ['module:item']], function () {
            ...
            Route::post('addPriceToProducts', 'ItemController@addPriceToProducts')->name('addPriceToProducts');
            Route::post('removePriceToProducts', 'ItemController@removePriceToProducts')->name('removePriceToProducts');
            ...
            Route::get('recommended/{id}/{recommended}', 'ItemController@recommended')->name('recommended');
            ...
            Route::get('panda/index', [pandaProductsController::class,"page"])->name('panda_page');
            Route::get('anaNinja', [pandaProductsController::class,"fetchProductPage"])->name('fetchProductPage');
            Route::post('panda/post', [pandaProductsController::class,"update"])->name('panda_post');
            Route::post('caraforEdit', [pandaProductsController::class,'insertCarrefour'])->name("carrefourEdit");
            Route::get('carafor', [pandaProductsController::class,'viewCarrefour'])->name('carafor');
        ...
        Route::get("panda/index", [pandaProductsController::class,"page"])->name("panda.index");
        Route::get('isAydaha/{user}', 'CustomerController@UpdateAydhaUser')->name('UpdateAydhaUser');
        Route::get('activeAydaha/{user}', 'CustomerController@activeAydhaUser')->name('activeAydhaUser');
        Route::post('amountAydhaUser/{user}', 'CustomerController@amountAydhaUser')->name('amountAydhaUser');


        Route::group(['prefix' => 'store', 'as' => 'store.'], function () {
            Route::get('get-stores-data/{store}', 'VendorController@get_store_data')->name('get-stores-data');
            Route::get('setCategory/{id}/{store}', 'VendorController@addCategoryToStore')->name('setCategory');
            ...
            Route::group(['middleware' => ['module:store']], function () {
                ...
                Route::get('busy/{store}/{status}', 'VendorController@busy')->name('busy');
        ...
        Route::group(['prefix' => 'order', 'as' => 'order.', 'middleware' => ['module:order']], function () {
            ...
            Route::get('list/all/api', 'OrderController@list_api')->name('api-list');
        ...
        Route::group(['prefix' => 'customer', 'as' => 'customer.', 'middleware' => ['module:customer_management']], function () {
            ...
            Route::get('aydha-list', 'CustomerController@aydha_list')->name('aydha-list');
        ...
        Route::group(['prefix' => 'transactions', 'as' => 'transactions.'], function () {
            ...
            Route::group(['prefix' => 'report', 'as' => 'report.', 'middleware' => ['module:report']], function () {
                ...
                Route::get('item-percent-report', 'ReportController@item_percent_report')->name('item-percent-report');
