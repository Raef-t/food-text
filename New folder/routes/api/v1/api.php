...
Route::group(['namespace' => 'Api\V1', 'middleware'=>'localization'], function () {
    Route::post('panda/post', [pandaProductsController::class,"update"]);
    Route::post('order_agian_with_request', [OrderController::class,"order_again_with_requets"]);
    Route::post('caraforEdit', [pandaProductsController::class,'insertCarrefour']);
route::post("send-otp", [CustomerAuthController::class,'sentOtp']);
route::post("verify_otp", [CustomerAuthController::class,'verify_otp']);
route::post("createAydhaUSer", [CustomerAuthController::class,'createAydhaUSer']);
    Route::get('/products', [pandaProductsController::class,'compare']);
    Route::get('advertisement/list', 'AdvertisementController@get_adds');
    Route::get('DeliveryMans', [DeliverymanController::class,"getList"]);
    ...
    Route::get('SubModule', 'ModuleController@indexSubModule');
    ...
    Route::group(['prefix' => 'delivery-man'], function () {
        ...
        Route::group(['middleware'=>['dm.api']], function () {
            ...
            Route::post('request', 'OrderController@store_request_services_parcel');
    ...
    Route::group(['middleware'=>['module-check']], function(){
        Route::group(['prefix' => 'customer', 'middleware' => 'auth:api'], function () {
            Route::post('package/subscription/{package}', [subscriptionsController::class,'userSubscriptions']);
        Route::get('package/subscriptions', [packageController::class,'getpackages']);

            Route::get('notifications', 'NotificationController@get_notifications');
            Route::get('info', 'CustomerController@info');
            Route::post('requestExchangeWalletMoney', 'CustomerController@requestExchangeWalletMoney');
            Route::post('ExchangeWalletMoney', 'CustomerController@ExchangeWalletMoney');
        ...
        Route::group(['prefix' => 'customer', 'middleware' => 'apiGuestCheck'], function () {
            ...
            Route::group(['prefix'=>'cart'], function() {
                Route::get('lists', 'CartController@get_carts');
