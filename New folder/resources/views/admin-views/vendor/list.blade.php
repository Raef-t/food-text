            ...
            <div class="table-responsive datatable-custom">
                <table id="columnSearchDatatable"
                    ...
                    <tr>
                        ...
                        <th class="text-uppercase border-0">{{translate('messages.busy')}}</th>
                    ...
                    @foreach($stores as $key=>$store)
                        <tr>
                            ...
                            <td>
                                <label class="toggle-switch toggle-switch-sm" for="busyCheckbox{{$store->id}}">
                                    <input type="checkbox" data-url="{{route('admin.store.busy',[$store->id,$store->busy?0:1])}}" data-message="{{translate('messages.you_want_to_change_this_store_status')}}" class="toggle-switch-input status_change_alert" id="busyCheckbox{{$store->id}}" {{$store->busy?'checked':''}}>
                                    <span class="toggle-switch-label">
                                            <span class="toggle-switch-indicator"></span>
                                        </span>
                                </label>
