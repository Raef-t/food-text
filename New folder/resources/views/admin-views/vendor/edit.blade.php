    ...
    @endphp
        ...
        data-original-title="{{translate('messages.store_lat_lng_warning')}}"><img src="{{asset('/public/assets/admin/img/info-circle.svg')}}" alt="{{translate('messages.store_lat_lng_warning')}}"></span></label>
                                        <input type="text"
                                                ...
                                                placeholder="{{ translate('messages.Ex:') }} 103.344322" id="longitude" value="{{old('longitude')}}" >
                                    </div>
                                      <div class="form-group mb-5">

    <input type="hidden"
           name="place_id" class="form-control"
           id="place_id" value="{{old('place_id')}}" required>
</div>
                                </div>
                                <div class="col-lg-8">
      ...
      $(document).on('ready', function () {
        ...
        function initMap() {
            ...
            map.controls[google.maps.ControlPosition.TOP_CENTER].push(input);
             input.style.width = "400px"; // Set the width of the search box
    input.style.height = "50px"; // Set the height of the search box
    input.style.fontSize = "16px"; // Set the font size
            let markers = [];
...
// Use PlacesService to get the details of the place
            service.getDetails({ placeId: place.place_id }, (details, status) => {
                if (status === google.maps.places.PlacesServiceStatus.OK) {
                    // Use the place_id instead of cid
                    const placeId = details.place_id; // This will always be available
            document.getElementById('place_id').value = placeId;

                    // Display or use the place_id as needed
