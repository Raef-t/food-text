    ...
    <div class="page-header pb-0">
        ...
        <div class="js-nav-scroller hs-nav-scroller-horizontal">
            ...
            <ul class="nav nav-tabs page-header-tabs mb-2">
                ...
                <li class="nav-item">
                    <a class="nav-link {{request('tab')=='price'?'active':''}}" href="{{route('admin.store.view', ['store'=>$store->id, 'tab'=> 'price'])}}"  aria-disabled="true">{{translate('messages.price')}}</a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link  {{request('tab')=='reports' ?'active':''}}" href="{{route('admin.store.view', ['store'=>$store->id, 'tab'=> 'reports'])}}"  aria-disabled="true">{{translate('messages.reports')}}</a>
                </li>
            </ul>
            <!-- End Nav -->
        </div>
