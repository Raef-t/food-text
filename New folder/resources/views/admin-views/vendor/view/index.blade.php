            ...
            <div class="card h-100 card--bg-1">
                <div class="card-body text-center d-flex flex-column justify-content-center align-items-center">
                    ...
                    <div class="d-flex align-items-center justify-content-center mt-3">
                        ...
                        <h2 class="cash--title text-white">{{\App\CentralLogics\Helpers::format_currency($wallet->collected_cash??0)}}</h2>
                    </div>
                </div>
            ...
            <div class="row g-3">
                ...
                <div class="col-sm-6">
                    <div class="resturant-card card--bg-4">
                        <h4 class="title">{{\App\CentralLogics\Helpers::format_currency($wallet->balance??0)}}</h4>
                ...
                <div class="col-sm-6">
                    <div class="resturant-card card--bg-1">
                        <h4 class="title">{{\App\CentralLogics\Helpers::format_currency($wallet->total_earning??0)}}</h4>
                    ...
                    <div class="resturant--info-address">
                        ...
                        <ul class="address-info list-unstyled list-unstyled-py-3 text-dark">
                            ...
                            <li>
                                ...
                                <a href="https://www.google.com/maps/place/?q=place_id:{{ data_get($store,'place_id',0)}}" target="_blank">{{$store->address}}</a></span>
