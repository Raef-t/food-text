                    ...
                    <table id="columnSearchDatatable"
                        ...
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th class="border-0">{{translate('messages.recommended')}}</th>
                        ...
                        @foreach($foods as $key=>$food)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <label class="toggle-switch toggle-switch-sm" for="stocksCheckbox-recommended-{{$food->id}}">
                                            <input type="checkbox" class="toggle-switch-input redirect-url" data-url="{{route('admin.item.recommended',[$food['id'],$food->recommended?0:1])}}" id="stocksCheckbox-recommended-{{$food->id}}" {{$food->recommended?'checked':''}}>
                                            <span class="toggle-switch-label">
                                                <span class="toggle-switch-indicator"></span>
                                            </span>
                                        </label>
