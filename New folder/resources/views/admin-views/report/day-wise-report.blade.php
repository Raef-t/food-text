                ...
                <div class="search--button-wrapper">
                    <h3 class="card-title">
                        {{ translate('messages.order_transactions') }} <span
                            class="badge badge-soft-secondary" id="countItems">1</span>
                    </h3>
                    ...
                    <table id="datatable" class="table table-thead-bordered table-align-middle card-table">
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th class="border-0">{{ translate('messages.mix_delivery_time') }}</th>
                                <th class="border-0">{{ translate('messages.min_delivery_time') }}</th>
                                <th class="border-0">{{ translate('messages.real_delivery_time') }}</th>
