                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn--container justify-content-center">
                                        ...
                                        <a class="btn action-btn btn--primary btn-outline-primary"
                                            href="{{route('admin.setModuleItems',["id"=>$module['id']])}}" title="{{translate('messages.edit_Business_Module')}}"><i class="tio-add"></i>
                                        </a>
                                          <div class="btn--container justify-content-center" >
                                     <form action="{{ route('admin.business-settings.module.delete', [$module['id']]) }}" method="POST" style="display:inline;" onsubmit="return confirm('Are you sure you want to delete this module?');">
    @csrf
    @method('DELETE')
    <button type="submit" class="btn action-btn btn--primary btn-outline-primary btn-delete" title="{{ translate('messages.delete_Business_Module') }}">
