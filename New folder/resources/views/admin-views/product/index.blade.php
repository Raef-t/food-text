                        ...
                        <div class="card-body">
                            ...
                            @endif
                                ...
                                <div class="row g-3">
                                    <div class="form-group">
                                        <label class="input-label"
                                               for="youtube_Link">{{ translate('messages.youtube_Link') }}
                                            ( {{ translate('messages.youtube_Link') }})
                                        </label>
                                        <input type="text" name="youtube" id="youtube"
                                               class="form-control" placeholder="{{ translate('messages.youtube_Link') }}"

                                        >
                                    </div>
                                    <div class="form-group">
                                        <label class="input-label"
                                               for="youtube_index">{{ translate('messages.index') }}
                                            ( {{ translate('messages.index') }}) 

                                        </label>
                                        <input type="text" name="youtube_index" id="youtube_index"
                                               class="form-control" placeholder="{{ translate('messages.index') }}"
                        ...
                        <div class="card-body d-flex flex-wrap align-items-center">
                            <div class="w-100 d-flex flex-wrap __gap-15px">
                                <div class="flex-grow-1 mx-auto">
                                    ...
                                    <!-- HTML element for spartanMultiImagePicker -->
                                    <input class="d-flex flex-wrap __gap-12px __new-coba"  type="file" id="coba" name="item_images[]" multiple>
