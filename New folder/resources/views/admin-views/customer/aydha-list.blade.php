                ...
                <div class="search--button-wrapper justify-content-end">
                    ...
                    <div class="col-sm-auto min--240">
                        <select name="filter" class="form-control js-select2-custom set-filter"
                            ...
                            <option  {{ request()->get('filter')  == '2ydha'?'selected':''}} value="2ydha">{{ translate('messages.2ydha_Customers') }}</option>
                        </select>
                    </div>
                        ...
                        @foreach ($customers as $key => $customer)
                            ...
                            <tr class="">
                                ...
                                <td class="table-column-pl-0">
                                    <a href="{{ route('admin.users.customer.view', [$customer->user['id']]) }}" class="text--hover">
                                        {{ $customer->user['f_name'] . ' ' . $customer->user['l_name'] }}
                                    </a>
                                </td>
                                <td>
                                    <div>
                                ...
                                <td>
                                    <label class="badge">
                                        {{  \App\CentralLogics\Helpers::format_currency( $customer->user->orders()->sum('order_amount'))}}
                                    </label>
                                </td>
                                <td>
                                    <label class="badge">
                                ...
                                <td>
                                    <a class="btn action-btn btn--warning btn-outline-warning"
                                       href="{{ route('admin.users.customer.view', [$customer->user['id']]) }}"
