                        ...
                        <div class="col-lg-4">
                            <div class="row g-3">
                                <div class="col-sm-6 col-lg-12">
                                    <div class="form-group mb-0">
                                        ...
                                        <select required name="identity_type" data-placeholder="{{ translate('messages.select_identity_type') }}" class="form-control js-select2-custom">
                                            ...
                                            <option value="passport">{{ translate('messages.National') }}</option>
                                            <option value="driving_license">{{ translate('messages.Resident') }} </option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-lg-12">
                                ...
                                <div class="col-sm-6 col-lg-12">
                                    <div class="form-group mb-0">
                                        <label class="input-label"
                                            for="exampleFormControlInput1">{{ translate('messages.carNumber') }}<span
                                                class="form-label-secondary text-danger" data-toggle="tooltip"
                                                data-placement="right"
                                                data-original-title="{{ translate('messages.Required.') }}"> *
                                            </span>
                                        ...
                                        <input type="text" name="carNumber" class="form-control"
                                            placeholder="{{ translate('messages.Ex:') }} 4356" required>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-lg-12">
                                    <div class="form-group mb-0">
                                        <label class="input-label"
                                            for="exampleFormControlInput1">{{ translate('messages.vehicleSequenceNumber') }}<span
                                                class="form-label-secondary text-danger" data-toggle="tooltip"
                                                data-placement="right"
                                                data-original-title="{{ translate('messages.vehicleSequenceNumber.') }}"> *
                                            </span>
                                        </label>
                                        <input type="text" name="vehicleSequenceNumber" class="form-control"
                                            placeholder="{{ translate('messages.Ex:') }} 4356" required>
                                    </div>
                                </div>
                            </div>
