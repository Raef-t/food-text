            ...
            <div class="row align-items-center py-2">
                <div class="col-sm mb-2 mb-sm-0">
                    <div class="d-flex align-items-center">
                        <img class="onerror-image" data-onerror-image="{{asset('/public/assets/admin/img/eshop.svg')}}"src="{{\App\CentralLogics\Helpers::get_image_helper($mod,"icon", asset('storage/app/public/module/').'/'.$mod->icon, asset('public/assets/admin/img/eshop.svg'), 'module/') }}"
                        width="38" alt="img">
            ...
            <div class="col-lg-8 col--xl-8">
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        {{-- Ensure you have necessary libraries included in your Blade template for drawing charts, e.g., Chart.js --}}
                        <script src="https://cdn.jsdelivr.net/npm/chart.js"></script>
                        <div class="col-lg-12">
                            <div class="card h-100">
                                <div class="card-header border-0">
                                    <h5 class="card-header-title">
                                        {{ translate('Order Processing Time') }}
                                    </h5>
                                </div>
                                <div class="card-body">
                                    <canvas id="order-processing-time-chart"></canvas>
                                </div>
                            </div>
                        </div>
                        ...
                        <script>
                            document.addEventListener('DOMContentLoaded', function () {
                                var ctx = document.getElementById('order-processing-time-chart').getContext('2d');

                                // Data for the chart (Assuming the variables are being passed from your backend)
                                var orderIds = @json(array_keys($orders)); // Assuming $orders contains order IDs as keys
                                var processingTimes = @json(array_values($orderProcessingTime)); // Assuming $orders contains processing times in minutes as values

                                var options = {
                                    type: 'line', // Line chart
                                    data: {
                                        labels: orderIds, // Order IDs as x-axis labels
                                        datasets: [{
                                            label: '{{ translate('Order Processing Time (minutes)') }}',
                                            data: processingTimes,
                                            borderColor: '#76ffcd', // Line color
                                            backgroundColor: 'rgba(118, 255, 205, 0.2)', // Gradient fill color
                                    ...
                                    options: {
                                            ...
                                            tooltip: {
                                                ...
                                                callbacks: {
                                                    label: function(tooltipItem) {
                                                        return tooltipItem.raw + ' {{ translate('minutes') }}';
                                                    }
                                                }
                                            }
                                        },
                                        scales: {
                                            ...
                                            y: {
                                                title: {
                                                    display: true,
                                                    text: '{{ translate('Processing Time (minutes)') }}'
                                                },
                                                beginAtZero: true,
                                                suggestedMax: 60, // You can adjust this value based on the expected range of processing times
                                            }
                                        },
                                        elements: {
                                            line: {
