                ...
                <div class="row g-3">
                    <div class="col-md-8">
                        <div class="row g-3">
                            ...
                            <div class="col-sm-6">
                                <div>
                                    <label class="input-label qcont" for="role_id">
                            ...
                            <div class="col-sm-6" id="stores-container">
                                <div>
                                    <label class="input-label qcont" for="Stores">
                                    ...
                                    <select class="form-control js-select2-custom w-100" name="Stores[]" id="Stores" multiple="multiple" required>
