                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row g-3 align-items-end">
                                <div class="col-sm-6 col-lg-4">
                                    ...
                                    <div class="form-group mb-0">
                                        ...
                                        <input  name="admin_commission" class="form-control"
                            ...
                            <div class="__bg-F8F9FC-card p-0 mt-4">
                                <div class="border-bottom p-3">
                                    <h4 class="card-title m-0 text--title">حساب سعر ال ك \ م بعد الحد المسموح</h4>
                                </div>
                                <div class="card-body">
                                    <div class="row g-3 align-items-end">
                                        <div class="col-sm-6 col-lg-4">
                                            @php($limit_for_delevry = \App\Models\BusinessSetting::where('key', 'limit_for_delevry')->first())
                                            <div class="form-group mb-0">
                                                <label class="form-label text-capitalize"
                                                    for="limit_for_delevry">عدد ك\م </label>
                                                <input type="number" name="limit_for_delevry" class="form-control"
                                                    id="limit_for_delevry" min="0" step=".01"  placeholder="{{ translate('messages.Ex:_10') }}"
                                                    value="{{ $limit_for_delevry ? $limit_for_delevry->value : 0 }}"
                                                    required>
                                            </div>
                                        </div>
                                        <div class="col-sm-6 col-lg-4">
                                            @php($price_after_limit = \App\Models\BusinessSetting::where('key', 'price_after_limit')->first())
                                            <div class="form-group mb-0">
                                                <label class="form-label text-capitalize"
                                                    for="price_after_limit">سعر ك\م</label>
                                                <input type="number" name="price_after_limit" class="form-control"
                                                    id="price_after_limit" min="0" step=".01"  placeholder="{{ translate('messages.Ex:_100') }}"
                                                    value="{{ $price_after_limit ? $price_after_limit->value : 0 }}"
                                                    required>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="__bg-F8F9FC-card p-0 mt-4">
                                <div class="border-bottom p-3">
                                    <h4 class="card-title m-0 text--title">سعر التوقف للمندوب</h4>
                                </div>
                                <div class="card-body">
                                    <div class="row g-3 align-items-end">
                                        <div class="col-sm-6 col-lg-4">
                                            @php($price_stops = \App\Models\BusinessSetting::where('key', 'stop_price')->first())
                                            <div class="form-group mb-0">
                                                <label class="form-label text-capitalize"
                                                       for="stop_price">السعر </label>
                                                <input type="number" name="stop_price" class="form-control"
                                                       id="price_after_limit" min="0" step=".01"  placeholder="{{ translate('messages.Ex:_100') }}"
                                                       value="{{ $price_stops ? $price_stops->value : 0 }}"
                                                       required>
                                            </div>
                                        </div>
                                    </div>
