...
<div class="row">
    <div class="form-group col-sm-6">
        ...
        <select id="exampleFormControlSelect3" name="PandaCategoryId" class="form-control js-select2-custom"
            ...
            <option value="353">اللحوم والدواجن</option>
            ...
            <option value="354">الأسماك والمأكولات البحرية طازجه</option>
            ...
            <option value="364">مجمدات اللحوم والدواجن</option>
            <option value="365"> الأسماك والمأكولات البحرية مجمده</option>
