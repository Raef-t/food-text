...
<main id="content" role="main" class="main pointer-event">
    ...
    <script src="@if(env('APP_MODE') == "live") {{asset('public/assets')}}@else{{asset('assets')}}@endif/admin/js/custom.js"></script>
    ...
    <script>
        ...
        var firebaseConfig = {
            apiKey: "AIzaSyDwksi6BRiVEemf7JHkuUNFH8dDx2Ypcsk",
            ...
            appId: "1:609386859120:web:7aed5918ac747459f402b5",
            measurementId: "G-GWS8Z48HK0"
        };
        ...
        function startFCM() {
            messaging
                ...
                console.error('a8a firebase:', error);
            });
        }
