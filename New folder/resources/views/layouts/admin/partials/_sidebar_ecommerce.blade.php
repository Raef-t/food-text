        ...
        <div class="navbar-vertical-container">
            ...
            <div class="navbar-vertical-content bg--005555" id="navbar-vertical-content">
                ...
                @endif
                    ...
                    @endif
                    <li
                            class="navbar-vertical-aside-has-menu  @yield('videos')">
                        <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:"
                           title="{{ translate('messages.videos') }}">
                            <i class="tio-tv-old nav-icon"></i>
                            <span
                                    class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{ translate('messages.videos') }}</span>
                        </a>
                        <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                            style="display: {{ Request::is('admin/advertisement*') ? 'block' : 'none' }}">

                            <li class="nav-item @yield('videos_store')">
                                <a class="nav-link " href="{{ route('admin.video.index') }}"
                                   title="{{ translate('messages.videos_store') }}">
                                    <span class="tio-circle nav-indicator-icon"></span>
                                    <span class="text-truncate">{{ translate('messages.videos_store') }}</span>
                                </a>
                            </li>
                            {{-- <li class="nav-item @yield('advertisement_request')">
                                 <a class="nav-link " href="{{ route('admin.advertisement.requestList') }}"
                            ...
                            <li class="nav-item @yield('videos_module')">
                                <a class="nav-link " href="{{ route('admin.video.index-Module') }}"
                                   title="{{ translate('messages.video_module') }}">
                                    <span class="tio-circle nav-indicator-icon"></span>
                                    <span class="text-truncate">{{ translate('messages.video_module') }}</span>
                                </a>
                            </li>
                            <li class="nav-item @yield('videos_App')">
                                <a class="nav-link " href="{{ route('admin.video.index-App') }}"
                                   title="{{ translate('messages.video_App') }}">
                                    <span class="tio-circle nav-indicator-icon"></span>
                                    <span class="text-truncate">{{ translate('messages.video_App') }}</span>
                                </a>
                            </li>
                        </ul>
                    </li>
                ...
                <!-- End marketing section -->
                    ...
                    <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/category*') ? 'active' : '' }}">
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"  style="display:{{ Request::is('admin/category*') ? 'block' : 'none' }}">
                                ...
                                <li class="nav-item   @yield('collection_category') {{Request::is('admin/category/collectionGroup') ? 'active' : '' }}">
                                    <a class="nav-link " href="{{ route('admin.category.getCategoryCollcetionView',['position'=>0]) }}" title="{{ translate('messages.collection_category') }}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="text-truncate">{{ translate('messages.collection_category') }}</span>
                                    </a>
                                </li>
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/item*') ? 'active' : '' }}">
                    ...
                    <ul class="js-navbar-vertical-aside-submenu nav nav-sub" style="display:{{ Request::is('admin/item*') ? 'block' : 'none' }}">
                        ...
                        <li class="nav-item {{ Request::is('admin/item/panda/index') || (Request::is('admin/item/panda/index/*') && (strpos(request()->fullUrl(), 'temp_product=1') == false && strpos(request()->fullUrl(), 'product_gellary=1') == false  ) ) ? 'active' : '' }}">
                            <a class="nav-link " href="{{ route('admin.item.panda_page') }}" title="{{ translate('messages.pandaItemsUpdate') }}">
                                <span class="tio-circle nav-indicator-icon"></span>
                                <span class="text-truncate">{{ translate('messages.pandaItemsUpdate') }}</span>
                            </a>
                        </li>
                        <li class="nav-item {{ Request::is('admin/item/carafor/') || (Request::is('admin/item/panda/*') && (strpos(request()->fullUrl(), 'temp_product=1') == false && strpos(request()->fullUrl(), 'product_gellary=1') == false  ) ) ? 'active' : '' }}">
                            <a class="nav-link " href="{{ route('admin.item.carafor') }}" title="{{ translate('messages.car') }}">
                                <span class="tio-circle nav-indicator-icon"></span>
                                <span class="text-truncate">{{ translate('messages.carrefourItemsUpdate') }}</span>
                            </a>
                        </li>
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/tasks') ? 'active' : '' }}">
                    <a class="nav-link " href="{{ route('admin.index-tasks') }}" title="{{ translate('messages.tasks') }}">
                        <span class="tio-calendar nav-icon"></span>
                        <span class="text-truncate text-capitalize">{{ translate('messages.tasks') }}</span>
                    </a>
                </li>
                @endif
                <!-- End Store -->
