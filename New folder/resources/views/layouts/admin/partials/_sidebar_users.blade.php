    ...
    <aside class="js-navbar-vertical-aside navbar navbar-vertical-aside navbar-vertical navbar-vertical-fixed navbar-expand-xl navbar-bordered  ">
        <div class="navbar-vertical-container">
            ...
            <div class="navbar-vertical-content bg--005555" id="navbar-vertical-content">
                ...
                <li class="navbar-vertical-aside-has-menu {{ (Request::is('admin/customer/aydha-list') || Request::is('admin/customer/aydha-list*')) ? 'active' : '' }}">
                    <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{ route('admin.customer.aydha-list') }}" title="{{ translate('messages.aydha') }}">
                        <i class="tio-poi-user nav-icon"></i>
                        <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                            {{ translate('messages.aydha') }}
                        </span>
                    </a>
                </li>
                ...
                @endif
                <!-- End Employee -->
                    <li class="nav-item {{ Request::is('admin/requestsData/') ? 'active' : '' }}">
                        <a class="nav-link " href="{{ route('admin.requestsData') }}" title="{{ translate('messages.requestsData') }}">
                            <span class="tio-files"></span>
                            <br>
                            <span class="text-truncate">{{ translate('messages.requestsData') }}</span>
                        </a>
                    </li>
